...
$str = preg_replace('/([^\s]{20})[^\s]+/', '<span title="$0">$1...</span>', $row_cat['name_cat']);
	?>
		<p><a class="button gray" style="width:200px" href="?id_cat=<?=$row_cat['id_cat']?>&name_cat=<?=$row_cat['name_cat']?>"><?=$str?></a>	</p>
...
?>
<h4>Выбранная категория. <span style="color:#F00";><?=$name_cat?></span></h4>
<h5>Товары повыбранной категории.</h5>
<?php
